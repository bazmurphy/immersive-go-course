...
// type S3ClientIntf interface {
// 	PutObject(*s3.PutObjectInput) (s3.PutObjectOutput, error)
// }

// type S3Uploader struct {
// 	// fields for all the stuff your are reading from .env
// 	s3c        S3ClientIntf // todo constructor
// 	bucketName string       // todo in constructor
// }

// // make a constructor for the above
// func (u S3Uploader) UploadImagesToS3(temporaryGrayscaleDirectory string) ([]UploadedImageObject, error) {
// 	log.Println("🔵 attempting: to upload the images to AWS S3...")
...
// 		// TODO: should I implement retry logic here in case the upload attempt fails for some network reason
// 		// USE: awsS3Client.PutObjectWithContext()
// 		_, err = u.s3c.PutObject(&s3.PutObjectInput{
// 			Bucket: aws.String(awsS3BucketName),
// 			Key:    aws.String(awsS3Key),
// 			Body:   openedFile,
// 		})
